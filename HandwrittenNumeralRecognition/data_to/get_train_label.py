...
save_list = []
image_paths = 'F:\Data_Set\HandwrittenNumeralRecognition\mnist_train'

save_label = r'F:\Vscode_python_programs\HandwrittenNumeralRecognition\data_to\train_label.txt'
